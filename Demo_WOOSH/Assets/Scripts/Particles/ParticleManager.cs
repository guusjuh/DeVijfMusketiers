...
public class ParticleManager : MonoBehaviour {
    ...
    private Dictionary<SpellManager.SpellType, ParticleBeam> beams = new Dictionary<SpellManager.SpellType, ParticleBeam>();
    ...
    public void PlaySpellParticle(SpellManager.SpellType effect, Vector3 position, Quaternion rotation)
    {
    ...
    private ParticleBeam CreateBeam(SpellManager.SpellType effect)
    {
    ...
    private Particles SpellToBeam(SpellManager.SpellType type)
    {
        switch (type)
        {
    ...
    private Particles SpellToParticle(SpellManager.SpellType type)
    {
        switch (type)
        {
            case SpellManager.SpellType.Fireball:
