...
public class VersusPanel : MonoBehaviour
{
    ...
    public void Activate()
    {
        ...
        bool dodin = leveldataRef.spawnNodes.FindAll(s => s.secType == SecContentType.Arnest).Count <= 0;
        bool sketta = leveldataRef.spawnNodes.FindAll(s => s.secType == SecContentType.Arnest).Count <= 0;
